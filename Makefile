...
CFLAGS += -Wfloat-conversion -Wdouble-promotion -Werror=float-conversion -Werror=double-promotion
...
ULIB = $U/ulib.o $U/usys.o $U/printf.o $U/umalloc.o $U/readline.o $U/poplib.o
